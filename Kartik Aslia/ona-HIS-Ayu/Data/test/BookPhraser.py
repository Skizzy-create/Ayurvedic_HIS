...
command = "You are an API that converts bodies of text into a single question and answer containg question on Ayurvedic medicine illness or symptoms. \
            ...
            convert this into a JSON format. Each JSON contains a single question with a single answer. Only respond with the JSON and no additional text. \n"
...
text = extract_text_from_pdf("C:\\Users\\LENOVO\\PycharmProjects\\Ayurvedic_HIS\\Kartik Aslia\\ona-HIS-Ayu\\Data\\PDfs\\shushruta samhita.pdf")
